        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form>
                    <!-- Supplier -->
                    <div class="row mb-2">
                        <label for="ItemNo" class="col-sm-2 col-form-label">No</label>
                        <div class="col-sm-4">
                            <input type="number" id="ItemNo" value="<?= $item["ItemNo"] ?>" class="form-control">
                        </div>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-md-4">
                            <textarea type="text" value="<?= $item["status"] ?>" id="status" class="form-control"><?= htmlspecialchars($item["status"]) ?></textarea>
                        </div>
                    ...
                    <div class="col-md-6 text-end mt4">
                        <button class="btn btn-primary me-1 mb-3" id="Update">Update</button>
