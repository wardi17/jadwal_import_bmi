        ...
        <div class="card">
            <div class="card-header">
                <div class="row col-md-12">
                    ...
                    <div class="col-md-11">
                        <h5 class="text-center">Finish Data</h5>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <input type="hidden" id="username" class="form-control" value="<?= $userid ?>">
                <input type="hidden" id="ready_old" class="form-control" value="<?= $item["ready"] ?>">
                <input type="hidden" id="etd_old" class="form-control" value="<?= $item["etd"] ?>">
                <input type="hidden" id="eta_old" class="form-control" value="<?= $item["eta"] ?>">
                <form>
                    <!-- Supplier -->
                    <!-- Date Ready -->
                    <div class="row mb-2">
                        <label for="tanggalfinish" class="col-sm-2 col-form-label">Tanggal Finish</label>
                        <div class="col-sm-2">
                            <input type="date" id="tanggalfinish" class="form-control">
                        </div>
                        <span id="tanggalfinishError" class="error"></span>
                    </div>
                    <!-- Supplier -->
                    <div class="row mb-2">
                        <label for="supplier" class="col-sm-2 col-form-label">Supplier</label>
                        <div class="col-sm-4">
                            <input type="text" disabled id="supplier" value="<?= $item["supplier"] ?>" class="form-control">
                        </div>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-2">
                            <input type="date" disabled id="ready" class="form-control">
                        </div>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-md-2">
                            <input type="date" disabled id="etd" class="form-control">
                        </div>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-md-4">
                            <textarea type="text" disabled value="<?= $item["status"] ?>" id="status" class="form-control"><?= htmlspecialchars($item["status"]) ?></textarea>
                        </div>
                    ...
                    <div class="col-md-6 text-end mt4">
                        <button class="btn btn-primary me-1 mb-3" id="FinishData">Save</button>
